...
public class OnePathogenSimuTest {
    ...
    public void currToDown() {
        ...
        onePathogenSimu.areaUnitArray[0][0].setPopFlowSpeed(0.4);
    ...
    public void currToDownR() {
        ...
        onePathogenSimu.areaUnitArray[1][0].setPopFlowSpeed(0.4);
    ...
    public void currToRightR() {
        ...
        onePathogenSimu.areaUnitArray[0][1].setPopFlowSpeed(0.4);
    ...
    public void currToUp() {
        ...
        onePathogenSimu.areaUnitArray[7][0].setPopFlowSpeed(0.4);
    ...
    public void currToUpR() {
        ...
        onePathogenSimu.areaUnitArray[6][0].setPopFlowSpeed(0.4);
    ...
    public void currToRightTopR() {
        ...
        onePathogenSimu.areaUnitArray[6][1].setPopFlowSpeed(0.4);
    ...
    public void currToLeft() {
        ...
        onePathogenSimu.areaUnitArray[7][7].setPopFlowSpeed(0.4);
    ...
    public void currToLeftBottom() {
        ...
        onePathogenSimu.areaUnitArray[0][7].setPopFlowSpeed(0.4);
    ...
    public void currToLeftBottomR() {
        ...
        onePathogenSimu.areaUnitArray[1][6].setPopFlowSpeed(0.4);
    ...
    public void currToLeftTopR() {
        ...
        onePathogenSimu.areaUnitArray[6][6].setPopFlowSpeed(0.4);
    ...
    public void calcOilSpreadAtTopRightCorner() {
        ...
        onePathogenSimu.areaUnitArray[1][7].setPopFlowSpeed(0.4);
        onePathogenSimu.areaUnitArray[1][6].setInfectNum(10);
